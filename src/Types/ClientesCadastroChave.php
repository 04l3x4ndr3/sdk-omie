...
class ClientesCadastroChave
{
    ...
    /**
     * @param int|null $codigo_cliente_omie
     * @return ClientesCadastroChave
     */
    public function setCodigoClienteOmie(?int $codigo_cliente_omie): ClientesCadastroChave
    {
        $this->codigo_cliente_omie = $codigo_cliente_omie;
        return $this;
    }
     ...
     * @return ClientesCadastroChave
     */
    public function setCodigoClienteIntegracao(?string $codigo_cliente_integracao): ClientesCadastroChave
    {
        $this->codigo_cliente_integracao = $codigo_cliente_integracao;
        return $this;
    }
